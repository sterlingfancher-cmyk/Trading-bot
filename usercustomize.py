...
VERSION = "usercustomize-entry-pipeline-composition-2026-08-05-v50-yfinance-hygiene"
...
def _patch_self_check_endpoints() -> None:
    try:
        ...
        wanted = [
            ...
            {"path": "/paper/performance-risk-calibration-status", "category": "risk", "required": False},
...
MODULES = (
    ...
    ("performance_risk_calibration", "app_and_module"),
