...
AUX_MODULES = (
    ...
    ("broad_momentum_discovery", (("apply", (core,)), ("register_routes", (app, core)))),
    ...
    try:
        ...
        if isinstance(light, list):
            for _path, _category, _required in (
                ...
                ("/paper/broad-momentum-discovery-status", "scanner", False),
                ("/paper/broad-momentum-candidates", "scanner", False),
